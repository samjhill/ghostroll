    ...
    with out_path.open("w", encoding="utf-8") as f:
        ...
        if has_tags:
            f.write(
                ...
                "<span class=\"tag-strip-hint\">Person 1, … from this session</span>"
                "</div>"
        ...
        f.write(
            ...
            "  /* GhostRoll writes Person N with parents exactly [\"Face\"]. Rekognition uses \"Face\" higher in hierarchies for Smile, Beard, etc. — only the single-parent form is treated as people. */"
            ...
            "    if(!s) continue;"
            "    const k=s.toLowerCase();"
            "    if(labelIsGhostrollFacePersonMirror(lab.parents)){"
