...
echo "Done."
echo "Next:"
echo "- If you previously mounted it manually and systemd complains it's already a mountpoint:"
echo "    sudo umount /mnt/auto-import"
echo "    sudo systemctl restart 'mnt-auto\\x2dimport.automount'"
